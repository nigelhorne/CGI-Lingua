...
# --- SURVIVOR: COND_INV_1218_2 (MEDIUM) line 1218 in _resolve_country_via_whois() ---
# Source:  unless($@ || !defined($whois) || (ref($whois) ne 'HASH')) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition unless to if
TODO: {
    local $TODO = 'Complete: COND_INV_1218_2 line 1218 in _resolve_country_via_whois()';
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::Lingua requires constructor arguments, add them here.
    my $obj = new_ok('CGI::Lingua');
...
# --- SURVIVOR: COND_INV_1304_2 (MEDIUM) line 1304 in _load_geoip() ---
# Source:  unless($db_present) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition unless to if
TODO: {
    local $TODO = 'Complete: COND_INV_1304_2 line 1304 in _load_geoip()';
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::Lingua requires constructor arguments, add them here.
    my $obj = new_ok('CGI::Lingua');
    # TODO: exercise line 1304 in _load_geoip() to detect the mutant
...
# --- SURVIVOR: COND_INV_1351_2 (MEDIUM) line 1351 in locale() ---
# Source:  if(defined($agent) && ($agent =~ /\((.+)\)/)) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_1351_2 line 1351 in locale()';
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::Lingua requires constructor arguments, add them here.
    my $obj = new_ok('CGI::Lingua');
    # TODO: exercise line 1351 in locale() to detect the mutant
    fail('COND_INV_1351_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_1356_4 (MEDIUM) line 1356 in locale() ---
# Source:  if($candidate =~ /^[a-zA-Z]{2}-([a-zA-Z]{2})$/) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_1356_4 line 1356 in locale()';
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::Lingua requires constructor arguments, add them here.
    my $obj = new_ok('CGI::Lingua');
    # TODO: exercise line 1356 in locale() to detect the mutant
    fail('COND_INV_1356_4: replace with real assertion');
}

# --- SURVIVOR: COND_INV_1358_5 (MEDIUM) line 1358 in locale() ---
# Source:  if(my $c = $self->_code2country($1)) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_1358_5 line 1358 in locale()';
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::Lingua requires constructor arguments, add them here.
    my $obj = new_ok('CGI::Lingua');
    # TODO: exercise line 1358 in locale() to detect the mutant
...
# --- SURVIVOR: COND_INV_1510_2 (MEDIUM) line 1510 in _code2language() ---
# Source:  if(defined($self->{_country})) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_1510_2 line 1510 in _code2language()';
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::Lingua requires constructor arguments, add them here.
    my $obj = new_ok('CGI::Lingua');
    # TODO: exercise line 1510 in _code2language() to detect the mutant
    fail('COND_INV_1510_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_1546_2 (MEDIUM) line 1546 in _code2country() ---
# Source:  if($self->{_country}) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_1546_2 line 1546 in _code2country()';
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::Lingua requires constructor arguments, add them here.
    my $obj = new_ok('CGI::Lingua');
    # TODO: exercise line 1546 in _code2country() to detect the mutant
