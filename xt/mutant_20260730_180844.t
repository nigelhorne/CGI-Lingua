...
# --- SURVIVOR: NUM_BOUNDARY_1850_23_== (HIGH) line 1850 in text_direction() ---
...
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_1850_23_== line 1850 in text_direction()';
    # Suggested boundary values to test: -1, 0, 1
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::Lingua requires constructor arguments, add them here.
    my $obj = new_ok('CGI::Lingua');
    # TODO: exercise line 1850 in text_direction() to detect the mutant
    fail('NUM_BOUNDARY_1850_23_==: replace with real assertion');
}
...
# --- SURVIVOR: NUM_BOUNDARY_1887_22_!= (HIGH) line 1887 in text_direction() ---
...
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_1887_22_!= line 1887 in text_direction()';
    # Suggested boundary values to test: -1, 0, 1
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::Lingua requires constructor arguments, add them here.
    my $obj = new_ok('CGI::Lingua');
    # TODO: exercise line 1887 in text_direction() to detect the mutant
    fail('NUM_BOUNDARY_1887_22_!=: replace with real assertion');
}
...
# --- SURVIVOR: NUM_BOUNDARY_1896_56_< (HIGH) line 1896 in text_direction() ---
...
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_1896_56_< line 1896 in text_direction()';
    # Suggested boundary values to test: -1, 0, 1
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::Lingua requires constructor arguments, add them here.
    my $obj = new_ok('CGI::Lingua');
    # TODO: exercise line 1896 in text_direction() to detect the mutant
    fail('NUM_BOUNDARY_1896_56_<: replace with real assertion');
}
...
# --- SURVIVOR: NUM_BOUNDARY_1906_39_> (HIGH) line 1906 in text_direction() ---
...
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_1906_39_> line 1906 in text_direction()';
    # Suggested boundary values to test: 0, 1, 2
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::Lingua requires constructor arguments, add them here.
    my $obj = new_ok('CGI::Lingua');
    # TODO: exercise line 1906 in text_direction() to detect the mutant
    fail('NUM_BOUNDARY_1906_39_>: replace with real assertion');
}
...
# --- SURVIVOR: NUM_BOUNDARY_1936_23_> (HIGH) line 1936 in text_direction() ---
...
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_1936_23_> line 1936 in text_direction()';
    # Suggested boundary values to test: 2, 3, 4
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::Lingua requires constructor arguments, add them here.
    my $obj = new_ok('CGI::Lingua');
    # TODO: exercise line 1936 in text_direction() to detect the mutant
    fail('NUM_BOUNDARY_1936_23_>: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_1937_23_> (HIGH) line 1937 in text_direction() ---
...
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_1937_23_> line 1937 in text_direction()';
    # Suggested boundary values to test: 6, 7, 8
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::Lingua requires constructor arguments, add them here.
    my $obj = new_ok('CGI::Lingua');
    # TODO: exercise line 1937 in text_direction() to detect the mutant
    fail('NUM_BOUNDARY_1937_23_>: replace with real assertion');
}
...
# --- SURVIVOR: NUM_BOUNDARY_1947_38_> (HIGH) line 1947 in text_direction() ---
...
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_1947_38_> line 1947 in text_direction()';
    # Suggested boundary values to test: -1, 0, 1
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::Lingua requires constructor arguments, add them here.
    my $obj = new_ok('CGI::Lingua');
    # TODO: exercise line 1947 in text_direction() to detect the mutant
    fail('NUM_BOUNDARY_1947_38_>: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_1948_41_< (HIGH) line 1948 in text_direction() ---
...
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_1948_41_< line 1948 in text_direction()';
    # Suggested boundary values to test: 10, 11, 12
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::Lingua requires constructor arguments, add them here.
    my $obj = new_ok('CGI::Lingua');
    # TODO: exercise line 1948 in text_direction() to detect the mutant
    fail('NUM_BOUNDARY_1948_41_<: replace with real assertion');
}
